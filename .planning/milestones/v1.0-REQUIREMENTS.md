# Requirements Archive: v1.0 Architecture reset (Omega)

**Archived:** 2026-03-28
**Status:** SHIPPED

For **new** work, see `.planning/REQUIREMENTS.md` after `/gsd-new-milestone` (stub until then).
...
## Ship-time note (milestone archive)

**Still open at v1.0 ship:** **DOC-01**, **DOC-02**, **RUN-01** remained **Pending** in the traceability table. Follow-up belongs in the next milestone requirements.
